...
and turn it into a percent-encoded string by replacing all whitespace with %20.
...
If we want to add a parameter to a url, there are certain characters that must be encoded in order to make the URL valid. 
