...
> Instruction
? Create a function named 'repeatNumbers' 
? that will return a string with each of the given values repeated the appropriate number of times,
...
let res = []
  for (array of data ) { 
  res.push(array[0].toString().repeat(array[1]))
}
return res.join(", ");
